...
features = torch.load('./input/data/sim_data/cached_dev_56')
# features = torch.load('./input/data/sim_data/cached_test_56')
...
bert_config = BertConfig.from_pretrained('/home/daiyizheng/.cache/torch/transformers/bert-pretrainmodel/bert/bert-base-chinese/config.json')
